...
def lambda_handler(event, context):
    ...
    if service == Service.FHIR.value or service.startswith(Service.SANDBOX.value):
    ...
    if save_to_blob:
        try:
            ...
            s3object = s3.Object(
                os.environ['BUCKET_NAME'], 'update.{}.json'.format(datetime.now().strftime('%Y%m%d%H%M%S'))
            )
            s3object.put(Body={'request data': data, 'response': response_update})
    ...
    return {'statusCode': 200, 'headers': {'Content-Type': 'application/json'}, 'body': response_update}
    ...
    event = {
        'body': {
            'cases': [
                {
                    'id': 'appointment-1531',
                    'new': {'roomId': 'OR-5', 'startTime': '2023-06-15T07:0:00', 'endTime': '2023-06-15T8:30:00'},
                    'old': {'roomId': 'OR-1', 'startTime': '2023-06-15T007:00:00', 'endTime': '2023-06-15T08:30:00'},
                },
                {
                    'id': 'appointment-2323',
                    'new': {'roomId': 'OR-5', 'startTime': '2023-06-15T08:30:00', 'endTime': '2023-06-15T11:15:00'},
                    'old': {'roomId': 'OR-1', 'startTime': '2023-06-15T08:30:00', 'endTime': '2023-06-15T11:15:00'},
                },
            ],
            'blocks': [
                {
                    'id': 'slot-151',
                    'new': {'roomId': 'OR-5', 'startTime': '2023-06-15T07:00:00', 'endTime': '2023-06-15T11:30:00'},
                    'old': {'roomId': 'OR-1', 'startTime': '2023-06-15T07:00:00', 'endTime': '2023-06-15T11:30:00'},
                }
            ],
        }
    }
